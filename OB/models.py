...
class wateringSchedule(db.Model):
    ...
    userWaterSchedule_id = db.Column(db.Integer, db.foriegnKey('userWaterSchedule.id'))
...
class userComment(db.Model):
    ...
    commentPost_id = db.Column(db.Integer, db.foriegnKey('commentPost.id'))
    userComment_id = db.Column(db.Integer, db.foriegnKey('userComment.id'))
